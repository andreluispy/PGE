...
class text:
    ...
    def draw(self, text='', font='Arial', font_size=10, position=(0, 0), color=(0, 0, 0), bold=False, italic=False, antialias=False, background=None):
        global display
        ...
        self.font = pygame.font.SysFont(font, font_size, bold, italic)
        # render(text, antialias, color, background=None) -> Surface
        self.textsurface = self.font.render(self.text, antialias, color, background)
